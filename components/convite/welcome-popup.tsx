...
export function WelcomePopup({ onClose }: { onClose?: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div className="animate-pop relative w-full max-w-sm overflow-hidden rounded-3xl border border-primary/25 bg-card p-7 text-center shadow-2xl shadow-primary/20">
        {/* Brilho superior */}
        <div
        ...
        {phase === 'success' && (
          <div key="success" className="animate-pop relative">
            <div className="relative mx-auto mt-6 flex size-20 items-center justify-center">
              ...
              <CheckCircle2 className="relative size-9 text-primary" aria-hidden="true" />
            </div>
        ...
        {phase === 'loading' && (
          <div key="loading" className="animate-pop relative flex flex-col items-center py-10">
        ...
        {phase === 'reward' && (
          <div key="reward" className="animate-pop relative">
            <div className="relative mx-auto mt-6 flex size-20 items-center justify-center">
              ...
              <span className="absolute inset-1.5 rounded-full bg-primary/10" aria-hidden="true" />
              <Gift className="relative size-9 text-primary" aria-hidden="true" />
            </div>

            <h2 className="relative mt-5 text-balance text-xl font-bold leading-tight text-foreground">
            ...
            <p className="relative mt-3 text-pretty text-sm font-medium leading-relaxed text-foreground">
            ...
            <p className="relative mt-4 flex items-center justify-center gap-1.5 text-xs text-muted-foreground">
