  ...
  useEffect(() => {
    ...
    fetch('/api/settings/public')
      ...
      .then((d) => {
        ...
        setPriceReady(true)
        // O InitiateCheckout NAO dispara mais aqui. Ele agora dispara somente
        // quando o cliente gera o PIX (dentro do PixModal), com os dados da
        // pessoa, para melhor atribuicao.
      })
      .catch(() => {
